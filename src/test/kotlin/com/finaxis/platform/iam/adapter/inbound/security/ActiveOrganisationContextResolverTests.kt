        ...
        val request =
            MockHttpServletRequest().apply {
                addHeader(
                    ...
                    contextService.issue(headerContext),
                )
                getSession(
                    true,
                )!!.setAttribute(SessionActiveOrganisationContextResolver.ATTRIBUTE, sessionContext)
            }
        val resolver =
            CompositeActiveOrganisationContextResolver(
