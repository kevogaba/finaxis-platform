...
class AccountingBoundaryRuleTests {
    ...
    fun `no bean accounting exposes declares a generic method`() {
        ...
        // code runs.
        //
        // That is a defect in Spring Modulith 2.1.0 rather than in the method, and it is still ours
        // to avoid: spring-boot-starter-opentelemetry is a runtime dependency, so the interceptor is
        // live in production and not merely under test. It is also invisible to every unit test,
        // because it only exists once the bean is proxied in a running context.
        //
