    ...
    companion object {
        ...
        fun policyRoutes() =
            listOf(
                ...
                Arguments.of("PUT", "/api/v1/auth/profile", RateLimitPolicyId.PLATFORM_COMMAND),
                Arguments.of("PATCH", "/api/v1/auth/profile", RateLimitPolicyId.PLATFORM_COMMAND),
                Arguments.of("DELETE", "/api/v1/auth/session", RateLimitPolicyId.PLATFORM_COMMAND),
                Arguments.of(
                    "GET",
                ...
                Arguments.of(
                    "POST",
                    "/api/v1/platform/tenants",
                    RateLimitPolicyId.PLATFORM_COMMAND,
                ),
                Arguments.of(
                    "PUT",
